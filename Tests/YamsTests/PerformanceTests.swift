...
class PerformanceTests: XCTestCase {
    func testSourceKittenIssue289() { // swiftlint:disable:this function_body_length
        ...
        self.measure {
            do {
                ...
                XCTAssertEqual(imports, ["/SourceKitten/.build/debug"])
                XCTAssertEqual(otherArguments, [
...
extension PerformanceTests {
    static var allTests: [(String, (PerformanceTests) -> () throws -> Void)] {
        return [
            ("testSourceKittenIssue289", testSourceKittenIssue289)
        ]
    }
}
